public class Map<T> where T : struct
{
    ...
    public List<Position> FindNeighbours(Position pos)
    {
        List<Position> positions = new List<Position>();
        positions.Add(pos + Direction.Up);
        positions.Add(pos + Direction.Right);
        positions.Add(pos + Direction.Down);
        positions.Add(pos + Direction.Left);
